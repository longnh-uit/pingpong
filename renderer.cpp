...
internal void
draw_number(s32 number, float x, float y, float size, u32 color) {
    float half_size = size * .5f;
    bool drew = false;
    ...
    while (number || !drew) {
        ...
        switch (digit) {
            ...
            case 4: {
                ...
                draw_rect(x, y, half_size, half_size, color);
                draw_rect(x + size, y, half_size, half_size * 5.f, color);
                x -= size * 4.f;
            } break;
            case 5: {
                draw_rect(x, y + size * 2.f, half_size * 3.f, half_size, color);
            ...
            case 6: {
                draw_rect(x - size, y, half_size, size * 1.5f, color);
                draw_rect(x, y + size * 2.f, size * 1.5f, half_size, color);
                draw_rect(x, y, half_size, half_size, color);
                draw_rect(x, y - size * 2.f, size * 1.5f, half_size, color);
                draw_rect(x + size, y - half_size, half_size, size, color);
                x -= size * 4.f;
            } break;
            case 7: {
                draw_rect(x, y + size * 2.f, size * 1.5f, half_size, color);
                draw_rect(x + size, y - half_size, half_size, size * 2, color);
                x -= size * 4.f;
            } break;
            case 8: {
